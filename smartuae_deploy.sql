...
--
-- Current Database: `smartuae`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `smartuae` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
INSERT INTO `admin_users` VALUES (1,'admin','$2b$10$QYNiQtJWMBYMnv1C0UoXhumpcuKCcFAVqDK54h/P0Ficu9YgrFEAW','Administrator','2026-04-13 21:02:17'),(2,'jabs','$2b$10$KabBHlVw45aYZEqle/.XOO3ajieE51ip2opR6yNJTJIJz14tYfHNy','Jabs','2026-05-18 10:28:58');
...
INSERT INTO `home_categories` VALUES (8,54,'Mobile Shops','📱',NULL,1),(9,26,'Cafés','☕',NULL,1),(10,97,'Universities','🎓',NULL,1),(11,34,'Shopping Malls','🏬',NULL,1),(12,85,'Hospitals','🏥',NULL,1),(13,181,'Vloggers','📹',NULL,1),(14,104,'App Development','📱',1,1),(15,163,'Wedding Planners','💍',NULL,1);
...
CREATE TABLE `users` (
  ...
  `emirate` varchar(100) DEFAULT NULL,
  `user_type` enum('admin','staff','user') NOT NULL DEFAULT 'user',
...
INSERT INTO `users` VALUES (2,'Abdul','jabbarmk@gmail.com','+971559164496','Dubai','user',NULL,1,'$2b$10$gLyqkniFlp1tjMWmgLLHnujFvf7gV6FBCh0.s/ZaXCCP9/TROKHo.',1,'2026-05-20 07:49:09','2026-05-20 07:49:09');
...
--
-- Dumping routines for database 'smartuae'
--
...
-- Dump completed on 2026-07-24  0:59:26
