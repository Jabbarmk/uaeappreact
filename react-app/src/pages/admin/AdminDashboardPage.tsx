...
const TILES: { label: string; path: string; icon: string; desc: string }[] = [
  ...
  { label: 'Property Categories',  path: '/admin/property-categories',   icon: '≡',  desc: 'Real estate types & icons' },
  { label: 'RE Companies',         path: '/admin/real-estate-companies', icon: '◈',  desc: 'Developers & major players' },
  { label: 'Properties',           path: '/admin/properties',            icon: '⌂',  desc: 'Property listings' },
  { label: 'Off-Plan Projects',    path: '/admin/real-estate-projects',  icon: '⬢',  desc: 'New developments' },
  { label: 'Event Categories',     path: '/admin/event-categories',      icon: '≡',  desc: 'Event types & icons' },
  { label: 'Events',               path: '/admin/events',                icon: '◉',  desc: 'Events & shows listings' },
